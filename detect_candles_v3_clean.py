...
# AI SIGNAL ENGINE
# ==========================
def generate_signal(latest, previous, trend):
    ...
    if (
        ...
        reason.append("Strong Red Candle")
        reason.append("Selling Momentum")
        ...
        reason.append("Strong Green Candle")
        reason.append("Buying Momentum")
...
signal, confidence, reason = generate_signal(
    latest,
    previous,
    trend
)
